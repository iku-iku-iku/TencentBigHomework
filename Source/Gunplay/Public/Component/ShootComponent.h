...
=======
	bool ShootDetect(const FVector& Start, const FVector& End, FHitResult& OutHit, const AActor* IgnoredActor = nullptr,
	                 TSubclassOf<AActor> IgnoredClass = nullptr) const;
